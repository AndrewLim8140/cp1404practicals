...
greater_than_11 =''
names_longer_than_11 = [name for name in full_names if len(name)>11]

greater_than_11 = ','.join(names_longer_than_11)
for i in range(0,len(names)):
    greater_than_11 = greater_than_11.replace(names[i],'')

print(greater_than_11)
